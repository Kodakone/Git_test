...
import sys
PROJECT_ROOT = Path(__file__).resolve().parents[1]  # Code_it-Basic-Project
sys.path.insert(0, str(PROJECT_ROOT))
from dataloader.dataset_load import DATA_ROOT, CACHE_DIR  # 위 import순서다르면 에러
...
# 증강시작 전 확인
V0_ROOT = Path(DATA_ROOT).parent / "yolo_dataset"  # 가져올 경로
IMG_DIR0 = V0_ROOT / "images" / "train"
LBL_DIR0 = V0_ROOT / "labels" / "train"

V1_ROOT = Path(DATA_ROOT).parent / "yolo_dataset_aug"  # 저장할 경로
IMG_DIR1 = V1_ROOT / "images" / "train"
LBL_DIR1 = V1_ROOT / "labels" / "train"
print("IMG_DIR0:", IMG_DIR0)
